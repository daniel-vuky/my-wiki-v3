...
export interface Folder { id: string; name: string; slug: string; color: string; description: string; sortOrder: number; count: number; parentId: string | null; favorite: boolean }
